    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <form action="{{ route('exportPendingOrders') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul>
                                <li>This report is getting all orders filtered by selected user with <b>start and end
                                        date</b>.</li>
                            </ul>
                            <!--=============================== User =============================-->
