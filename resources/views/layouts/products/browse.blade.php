        ...
        <div class="col-sm-4 py-1">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal{{$product->id}}" data-product="{{$product->name}}">
                        Delete
                    </button>
                    @include('components.modal',['id'=>$product->id,'name'=>$product->name,'root'=>'products.destroy','model_name'=>'product'])
                </div>
            </div>
        </div>
        @endforeach
