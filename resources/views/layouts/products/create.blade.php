                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{route('products.store')}}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="price" placeholder="price" name="price" value="" autofocus>
                            {{-- Error --}}
                            @error('price')
                            <span class="invalid-feedback" role="alert">
                                <p>{{ $message }}</p>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea class="form-control" placeholder="Descripe this product" id="description" name="description" style="height: 30px"></textarea>
                            {{-- Error --}}
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <p>{{ $message }}</p>
