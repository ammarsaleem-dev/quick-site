                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon2">Customer Type</span>
                                <select class="form-control" id="customer_type" name="customer_type">
                                    <option value="RETAIL-CUSTOMER"
                                        {{ $customer->customer_type == 'RETAIL-CUSTOMER' ? 'selected' : '' }}>Retail
                                        Customer</option>
                                    <option value="WHOLESALE-CUSTOMER"
                                        {{ $customer->customer_type == 'WHOLESALE-CUSTOMER' ? 'selected' : '' }}>WholeSale
                                        Customer</option>
                                </select>
                                @error('customer_type')
                                    <span class="invalid-feedback" role="alert">
